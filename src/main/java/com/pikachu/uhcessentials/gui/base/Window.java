...
public abstract class Window extends Gui {
    ...
    public Window(String name, int defaultX, int defaultY) {
        ...
        x = UHCEssentials.getConfig().getInt("x", name, defaultX, Integer.MIN_VALUE, Integer.MAX_VALUE,
                "Controls the x coordinate of the " + name + " window");
        y = UHCEssentials.getConfig().getInt("y", name, defaultY, Integer.MIN_VALUE, Integer.MAX_VALUE,
                "Controls the x coordinate of the " + name + " window");
        enabled = UHCEssentials.getConfig().getBoolean("enabled", name, true,
    ...
    public void save(boolean alsoSaveConfig) {
        UHCEssentials.getConfig().get(getName(), "x", getDefaultX(),
                "Controls the x coordinate of the " + getName() + " window").set(getX());
        UHCEssentials.getConfig().get(getName(), "y", getDefaultY(),
                "Controls the y coordinate of the " + getName() + " window").set(getY());
        UHCEssentials.getConfig().get(getName(), "enabled", true,
